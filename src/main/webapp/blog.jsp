...
<head>
    ...
    <style>
        .blog-image {
            ...
            height: 200px; /* Fixed height to reduce image length */
    ...
    <section class="blog-section">
        <div class="container">
            ...
            <div class="pagination">
                <% if (currentPage > 1) { %>
                <a href="${pageContext.request.contextPath}/blogs?page=<%= currentPage - 1 %>" class="pagination-link">« Previous</a>
                <% } %>
                ...
                <a href="${pageContext.request.contextPath}/blogs?page=<%= currentPage + 1 %>" class="pagination-link">Next »</a>
                <% } %>
            </div>
            <% } %>
            <% } else { %>
